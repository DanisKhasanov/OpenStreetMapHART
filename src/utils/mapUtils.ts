...
export const filterUserProperties = (allProperties: Record<string, any>): Record<string, any> => {
...
export const createVectorLayer = (features: any[]): VectorLayer<VectorSource> => {
